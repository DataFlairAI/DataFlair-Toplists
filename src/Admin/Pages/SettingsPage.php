                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description">
                                        ...
                                        <br><strong>Brands sync will actually call: <?php echo esc_html(($this->brandsEffectiveBaseResolver)() . '/brands'); ?></strong>
                                        &mdash; this reflects the version selected above even when the API
